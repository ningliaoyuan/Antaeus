...
<div class="ques_know column2">
    ...
    <div class="box1 subheader">
        ...
        <div class="rateandnext right">
            <div class="rate">
                <span>此知识点的价值为&nbsp;4&nbsp;/&nbsp;5&nbsp;&nbsp;</span>
                <div class="stars"><%= Html.GetStars(4, "yellow")%></div>
            </div>
            <div class="redirect">
                <a href="#" class="next">下一个（随机抽取）</a>
                <a href="#" class="previous">上一个</a>
            </div>
        </div>
        <div class="clear"></div>
    </div>
        ...
        <div class="box2 answer">
            <div class="bar2">
            	<div class="left">
                	...
                	<div class="information">感谢&nbsp;<span class="blue">Lanslot</span>&nbsp;,&nbsp;<span class="blue">Ningliaoyuan</span>&nbsp;,&nbsp;<span class="blue">Lozt</span>&nbsp;对此知识点所做出的贡献</div>
                </div>
                <div class="right">
                	<a class="btn-small btn-edit" href="#">编辑此知识点</a>
                    <div class="clear"></div><div class="blank10"></div>
                    <a class="btn-small btn-history" href="#">查看历史版本</a>
                </div>
                <div class="clear"></div>
            </div>
            <div class="wiki">
    ...
    <div class="columnright">
        ...
        <div class="box3 w-related">
            <h3 class="box-title">与此知识点相关的题目</h3>
            <div class="context">
            	<div class="item">
                	<b>阅读：28393</b>
                    <span>价值3.5</span>
