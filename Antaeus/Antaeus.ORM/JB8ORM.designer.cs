...
namespace Antaeus.ORM
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="Antaeus_DB")]
    ...
    partial void OnCacheChanged();
		...
		[Column(Name="[Key]", Storage="_Key", DbType="NVarChar(500) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string Key
		{
			get
			{
		...
		[Column(Storage="_MaxID", DbType="BigInt NOT NULL")]
		public long MaxID
		{
			get
			{
		...
		[Column(Storage="_Cache", DbType="Int NOT NULL")]
		public int Cache
		{
			get
			{
    ...
    partial void OnAbstractChanged();
		...
		[Column(Storage="_QuestionID", DbType="BigInt NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_CrTime", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_Abstract", DbType="NVarChar(4000) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Category_QB", Storage="_Category", ThisKey="CategoryID", OtherKey="CategoryID", IsForeignKey=true)]
    ...
    partial void OnQuestionTypeChanged();
		...
		[Column(Storage="_SourceXml", DbType="NVarChar(4000) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_QuestionType", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
    ...
    partial void OnNameChanged();
		...
		[Column(Storage="_RoleID", DbType="BigInt NOT NULL", IsPrimaryKey=true)]
		public long RoleID
		{
			get
			{
    ...
    partial void OnEmailChanged();
		...
		[Column(Storage="_UserName", DbType="NVarChar(200) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_PasswordHash", DbType="NVarChar(400) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_PasswordSalt", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_DisplayName", DbType="NVarChar(500) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Email", DbType="NVarChar(500) NOT NULL", CanBeNull=false)]
		public string Email
		{
			get
			{
		...
		[Association(Name="User_UserRole", Storage="_UserRoles", ThisKey="UserName", OtherKey="UserName")]
		public EntitySet<UserRole> UserRoles
		{
			get
			{
    ...
    partial void OnRoleIDChanged();
		...
		[Column(Storage="_UserRoleID", DbType="BigInt NOT NULL", IsPrimaryKey=true)]
		...
		[Association(Name="User_UserRole", Storage="_User", ThisKey="UserName", OtherKey="UserName", IsForeignKey=true)]
		public User User
		{
			get
			{
    ...
    partial void OnQuestionTypeMetaChanged();
		...
		[Column(Storage="_CategoryID", DbType="BigInt NOT NULL", IsPrimaryKey=true)]
		public long CategoryID
		{
			get
			{
		...
		[Column(Storage="_QuestionTypeMeta", DbType="NVarChar(3000)")]
		...
		[Association(Name="Category_QB", Storage="_QBs", ThisKey="CategoryID", OtherKey="CategoryID")]
    ...
    partial void OnCreatedTimeChanged();
		...
		[Column(Storage="_KID", DbType="VarChar(600) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string KID
		{
			get
			{
		...
		[Column(Storage="_CurrentWikiContentID", DbType="BigInt NOT NULL")]
		...
		[Column(Storage="_MaxReversion", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Wiki_WikiContent", Storage="_WikiContents", ThisKey="KID", OtherKey="KID")]
    ...
    partial void OnCreatedTimeChanged();
		...
		[Column(Storage="_WikiContentID", DbType="BigInt NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_Reversion", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Wiki_WikiContent", Storage="_Wiki", ThisKey="KID", OtherKey="KID", IsForeignKey=true)]
		public Wiki Wiki
		{
			get
			{
    ...
    partial void OnCreatedTimeChanged();
		...
		[Column(Storage="_RateID", DbType="BigInt NOT NULL", IsPrimaryKey=true)]
		public long RateID
		{
			get
			{
    ...
    partial void OnCrTimeChanged();
		...
		[Column(Storage="_UserAnswerQBID", DbType="BigInt NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_Answer", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_Correct", DbType="Bit NOT NULL")]
		public bool Correct
		{
			get
			{
    ...
    partial void OnCreatedTimeChanged();
		...
		[Column(Storage="_CommentID", DbType="BigInt NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_Floor", DbType="Int NOT NULL")]
		public int Floor
		{
			get
			{
		...
		[Column(Storage="_ParentCID", DbType="NVarChar(4000) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_CrUserName", DbType="NVarChar(4000) NOT NULL", CanBeNull=false)]
		public string CrUserName
		{
			get
			{
